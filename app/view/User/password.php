        ...
        <div class="col-md-10 mx-auto col-lg-5">
            <form class="p-4 p-md-5 border rounded-3 bg-light" method="post" action="/users/password">
                <div class="form-floating mb-3">
                    <input type="text" name="id" value="<?= $model['user']['id'] ?>" class="form-control" id="id" placeholder="id" disabled>
                    <label for="id">Id</label>
                </div>
                <div class="form-floating mb-3">
                    <input name="oldPassword" value="<?= $_POST['oldPassword'] ?? '' ?>" type="password" class="form-control" id="oldPassword"
                           placeholder="old password">
                    <label for="oldPassword">Old Password</label>
                </div>
                <div class="form-floating mb-3">
                    <input name="newPassword" value="<?= $model['newPassword'] ?? '' ?>" type="password" class="form-control" id="newPassword"
